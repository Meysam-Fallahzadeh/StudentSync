...
public static class NationalCodeExtentions
{
    public static bool IsInValidNationalCode(this string nationalCode)
    {
        ...
        if (nationalCode.Length != 10)
            throw new Exception("The length of the national code must be 10 characters!!!");

        var regex = new Regex(@"\d{10}");
        if (!regex.IsMatch(nationalCode))
            throw new Exception("The national code consists of 10 numerical digits; Please enter the correct national code!!!");
